...
if __name__ == '__main__':
    ...
    radio = tk.IntVar()
    기술분류1radio = tk.Radiobutton(root, text = '기술분류 X', variable = radio, value = 1, command = Data.Rb1)
    기술분류2radio = tk.Radiobutton(root, text = '기술분류 2개', variable = radio, value = 2, command = Data.Rb2)
    기술분류3radio = tk.Radiobutton(root, text = '기술분류 3개', variable = radio, value = 3, command = Data.Rb3)
    기술분류4radio = tk.Radiobutton(root, text = '기술분류 4개', variable = radio, value = 4, command = Data.Rb4)
